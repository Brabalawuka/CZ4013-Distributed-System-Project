...
//    //TODO: Deal with situation that listener doesnt exist
//    public <T extends BaseXYZZObject, K extends BaseListener> Optional<BaseXYZZObject> notifySingleListenerMethod(Method listener, BaseXYZZMessage<T> message){
//        return Optional.ofNullable(listenerMap.get(listener.getClass().getName())).flatMap(l -> listener.invoke(l, message));
//    }
}
